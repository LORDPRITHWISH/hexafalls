      ...
      <div className="aspect-[3/4] relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-gravity-darker via-gravity-darker/60 to-transparent">
          <div className="absolute bottom-0 left-0 right-0 p-4">
            <h3 className="text-xl font-semibold text-white mb-1 leading-tight group-hover:text-gravity-gold transition-colors">
              {name}
            </h3>
        ...
        <div className="flex space-x-3">
          {socialLinks.twitter && (
            <a
              ...
              className="text-white/60 hover:text-gravity-gold transition-colors"
  ...
  const speakers = [
    {
      ...
      description:
        "Six-fingered author of the journals and interdimensional traveler. Expert in quantum computing and paranormal programming paradigms.",
      socialLinks: {
        twitter: "#",
        linkedin: "#",
        website: "#",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2074&q=80",
      description:
        "Eccentric inventor and robotics genius. Will be leading our hardware hacking workshop and sharing insights on building anomaly detection devices.",
      socialLinks: {
        twitter: "#",
        website: "#",
      },
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2074&q=80",
      description:
        "Creative design expert specializing in colorful, user-friendly interfaces. Will teach you how to make your projects pop with personality.",
      socialLinks: {
        twitter: "#",
        linkedin: "#",
      },
    },
    {
      ...
      description:
        "Researcher and problem solver extraordinaire. Will be leading sessions on logical thinking, debugging, and methodical approaches to coding mysteries.",
      socialLinks: {
        twitter: "#",
        website: "#",
      },
  ...
  const judges = [
    {
      ...
      description:
        "Cool-headed tech lead with a sharp eye for practical solutions and real-world applications. Looking for projects with both style and substance.",
      socialLinks: {
        linkedin: "#",
        website: "#",
      },
    },
    {
      ...
      description:
        "Handyman extraordinaire with a passion for gaming and fixing complex systems. Appreciates technical creativity and unconventional approaches.",
      socialLinks: {
        twitter: "#",
        linkedin: "#",
      },
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1531384441138-2736e62e0919?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2077&q=80",
      description:
        "Interdimensional being with an eye for detail. Criteria for judging remain shrouded in mystery. Approach with caution and don't make any deals!",
      socialLinks: {
        website: "#",
      },
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2022&q=80",
      description:
        "Venture capital representative with high standards for polish and presentation. Looking for projects with commercial potential and refined user experience.",
      socialLinks: {
        twitter: "#",
        linkedin: "#",
      },
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-16">
          ...
          >
            Meet the enigmatic experts who will guide and judge your paranormal
            projects
          </p>
        </div>
        ...
        <div className="space-y-16">
          <div>
            <h3
              className={cn(
                "font-mystery text-2xl md:text-3xl mb-8 text-center",
                "transform transition-all duration-700 delay-300 jolly-lodger-regular text-green-400 ",
                isVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-8"
              )}
          ...
          <div>
            <h3
              className={cn(
                ...
                "transform transition-all duration-700 delay-800 jolly-lodger-regular text-green-400",
                isVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-8"
              )}

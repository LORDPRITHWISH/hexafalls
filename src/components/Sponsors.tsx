...
const SponsorLogo: React.FC<SponsorLogoProps> = ({ name, level, delay, isVisible }) => {
  const levelClasses = {
    gold: 'border-gravity-gold/30 bg-gravity-gold/5 hover:bg-gravity-gold/10 hover:border-gravity-gold/50',
    silver: 'border-white/20 bg-white/5 hover:bg-white/10 hover:border-white/30',
    bronze: 'border-amber-700/20 bg-amber-700/5 hover:bg-amber-700/10 hover:border-amber-700/30',
  };
  ...
  return (
    ...
    >
      <div className={cn(
        ...
        level === 'gold' ? 'text-gravity-gold text-xl' : 
        level === 'silver' ? 'text-white/90 text-lg' : 
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          >
            These enigmatic organizations have emerged from the shadows to support our hackathon
          </p>
        </div>
        ...
        <div className="space-y-12">
          ...
          <div className="space-y-4">
            <h3 
              className={cn(
                "text-center font-medium text-lg md:text-xl text-white/90 mb-6",
        ...
        >
          ...
          <p className="text-white/70 max-w-2xl mx-auto mb-6">
            Join our league of mysterious backers and support the next generation of coding detectives.
          </p>
          <a
            href="#"
            className={cn(
